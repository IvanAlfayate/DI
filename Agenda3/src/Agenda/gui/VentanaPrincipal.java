...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    public VentanaPrincipal() {
        initComponents();
        modelo = new ContactosTableModel(LogicaNegocio.getListaContactos());
        jTableAgenda.setModel(modelo); //creamos el objeto pasandole al constructor la lista de contactos de la clase logicaNegocio
    ...
    private void jMenu1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu1MouseClicked
        int fila;
        fila = jTableAgenda.getSelectedRow();
        int columna = jTableAgenda.getSelectedColumn();
        if (fila == -1) { //si no hay una fila seleccionada
            jTextFieldError.setText("Selecciona una fila");
        } else {  //si la fila esta seleccionada extraemos el texto
            jLabel1.setText((String) modelo.getValueAt(fila, columna));
    ...
    private void refrescaTabla() {
        ...
        jTableAgenda.setModel(ctm);
        TableRowSorter<ContactosTableModel> ordena = new TableRowSorter<>(ctm);
        jTableAgenda.setRowSorter(ordena);
        ordena.setRowFilter( RowFilter.regexFilter("^a", 0));
